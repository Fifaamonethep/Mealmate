...
export async function seedInitialData() {
  try {
    ...
    console.warn('⚠️ Seed data initialization skipped or handled:', err.message || err)
  }
}

seedInitialData().catch(err => console.warn('⚠️ Seed async catch:', err.message || err))
